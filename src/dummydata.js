import graphic from "../src/internship/graphic.gif";
import web from "../src/internship/web.gif";
import app from "../src/internship/app.gif";
import data from "../src/internship/data.gif";
import game from "../src/internship/game.gif";
import webd from "../src/internship/webd.gif";
import verify from "../src/internship/verified1.gif";
import logo from "../src/internship/Simplbyte2.png";

export {data,app,game,graphic,webd,web,verify,logo};
